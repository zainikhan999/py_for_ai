...
const HeroContent: React.FC<HeroContentProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="inline-flex items-center gap-2 bg-linear-to-r from-emerald-500/10 to-cyan-500/10 border border-emerald-500/30 px-4 py-2 rounded-lg font-mono backdrop-blur">
      ...
      <div className="space-y-2">
        ...
        <h1 className="text-5xl lg:text-6xl font-bold font-mono leading-tight pl-4">
          <span className="text-gray-500">{"<"}</span>
      ...
      <div className="font-mono text-gray-400 leading-relaxed pl-4 space-y-1">
      ...
      <div className="border-t border-emerald-500/30 pt-8">
        <div className="bg-[#0d0d0d] border border-emerald-500/30 rounded-lg p-1 mb-4 inline-flex items-center gap-2">
          <div className="flex gap-1.5 px-2">
            <div className="w-3 h-3 rounded-full bg-red-500"></div>
            <div className="w-3 h-3 rounded-full bg-yellow-500"></div>
            <div className="w-3 h-3 rounded-full bg-green-500"></div>
          </div>
          <span className="text-xs text-gray-500 font-mono pr-2">stats.py</span>
        </div>
